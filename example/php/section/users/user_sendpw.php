	...
	<tr>
		<td><? $email = $_POST["email"]; $foundemail = 0;
			...
			<? } 
				...
				print "Das Passwort wurde so eben neugeneriert - schauen Sie nach!";
			    }
...
<br>
<form method="post" action="index.php?section=user_sendpw">
<table border="0" cellspacing="1" cellpadding="0">
	...
	<table width="198" border="0" cellpadding="0" cellspacing="1" class="balken">
        ...
        <tr>
            <td height="13" align="right"><input type="image" name="ok" src="gfx/design/t_r11_c6.jpg" style="background-image:url('gfx/design/t_r11_c6.jpg'); border:0" value="-"></td>
        </tr>
    </table>
</form>
<? } ?>